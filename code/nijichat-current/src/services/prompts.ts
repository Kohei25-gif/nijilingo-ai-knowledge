...
5. 感情極性: positive/negative/neutral
   ...
   - neutral: 事実報告・確認など感情を強く含まないもの
6. モダリティ: 報告/依頼/感謝/質問/感想/提案/その他
   - 例: 「遅れてる」→ 報告、「見てくれる？」→ 依頼、「ありがとう」→ 感謝
7. 主語: 誰が（明示されている場合のみ記載。省略されていれば「省略」と記載。推測で補填しない）
8. 対象: 誰に/何に（なければ「なし」）
...
12. 確信度: 確定/推測/可能性/伝聞
   - 確定: 〜だ、〜です、〜た、〜てた、〜ていた（事実として述べる。過去形「〜てた」「〜た」は確定）
   - 推測: 〜と思う、〜だろう（自分の考え）
   - 可能性: 〜かも、〜かもしれない（確信が低い/不確か）
   - 伝聞: 〜らしい、〜そうだ、〜って（文末）、〜だって、〜んだって（誰かから聞いた情報）
   ★ 注意: 「〜てた」「〜ていた」は過去の事実なので「確定」。「推測」にしない。
   ★ 注意: 文末の「〜って」は伝聞。「〜と思う」は推測。混同しない。
   ★ 例: 「電車が止まってた」→ 確定（過去の事実）
...
【例1】
入力: 「ごんたが寝てから向かいます」
{"主題":"移動","動作":"向かう","意図":"報告","感情極性":"neutral","モダリティ":"報告","主語":"省略","対象":"なし","目的格":"なし","願望":"なし","人称":"一人称単数","確信度":"確定","固有名詞":[{"text":"ごんた","type":"person","読み":"Gonta","敬称":"なし"}]}
...
【例2】
入力: 「田中さんが来ます」
{"主題":"来訪","動作":"来る","意図":"報告","感情極性":"neutral","モダリティ":"報告","主語":"田中さん","対象":"なし","目的格":"なし","願望":"なし","人称":"三人称","確信度":"確定","固有名詞":[{"text":"田中","type":"person","敬称":"さん"}]}
※ 敬称あり → 他人 → 適切な敬意を払う

【例3】
入力: 「電車止まってるかも」
{"主題":"電車","動作":"止まっている","意図":"報告","感情極性":"negative","モダリティ":"報告","主語":"電車","対象":"なし","目的格":"なし","願望":"なし","人称":"三人称","確信度":"可能性","固有名詞":[]}

【例3b】
入力: 「電車が止まってた」
{"主題":"電車","動作":"止まっていた","動作の意味":"stop","意図":"報告","感情極性":"negative","モダリティ":"報告","主語":"電車","対象":"なし","目的格":"なし","願望":"なし","人称":"三人称","確信度":"確定","固有名詞":[]}
※ 「〜てた」=「〜ていた」= 過去の事実 → 確信度は「確定」（推測ではない）

【例3c】
入力: 「遅れてごめん、電車が止まってた」
{"主題":"遅刻の謝罪","動作":"遅れる","動作の意味":"be late","意図":"謝罪","感情極性":"negative","モダリティ":"感想","主語":"省略","対象":"なし","目的格":"なし","願望":"なし","人称":"一人称単数","確信度":"確定","固有名詞":[]}
※ 複文の場合、主文の主語・意図を優先（「遅れてごめん」が主文→主語は話者→一人称単数）
※ 「〜てた」= 過去の事実 → 確信度は「確定」

【例3d】
入力: 「明日は晴れるって」
{"主題":"天気","動作":"晴れる","動作の意味":"be sunny","意図":"報告","感情極性":"neutral","モダリティ":"報告","主語":"省略","対象":"なし","目的格":"なし","願望":"なし","人称":"三人称","確信度":"伝聞","固有名詞":[]}
※ 文末の「〜って」= 誰かから聞いた情報 → 確信度は「伝聞」（推測ではない）

【例4】
入力: 「雄太が会社くびになったらしいよ」
{"主題":"雄太の解雇","動作":"くびになった","意図":"報告","感情極性":"negative","モダリティ":"報告","主語":"雄太","対象":"なし","目的格":"なし","願望":"なし","人称":"三人称","確信度":"伝聞","固有名詞":[{"text":"雄太","type":"person","敬称":"なし"}]}
※ 「らしい」= 伝聞 → "I heard" / "apparently" で翻訳

【例5】
入力: 「君を抱いていたい」
{"主題":"抱擁","動作":"抱く","意図":"報告","感情極性":"positive","モダリティ":"感想","主語":"省略","対象":"なし","目的格":"君","願望":"あり","人称":"一人称単数","確信度":"確定","固有名詞":[]}
※ 目的格「君」→ 翻訳時に「君」は目的語
