...
| メンバー | 役割 |
|----------|------|
| **ベニー** | オーナー、方針決定、フィードバック |
| **ベン（Clawdbot）** | 情報収集・背景共有・合格基準の相談・ログ管理 |
| **クロちゃん（君）** | テスト実行・ファイル分割・コード修正 |

**ポイント**: クロちゃんがどんどんテストしていくスタイル
...
| リポジトリ | 公開 | 用途 |
|-----------|------|------|
| **NijiChat** | ❌ Private | アプリ本体 |
| **nijilingo-ai-knowledge** | ✅ Public | ログ・分析・設計ガイド |
